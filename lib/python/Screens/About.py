...
class About(Screen):
	...
	def populate(self):
		...
		self["lab2"] = StaticText(_("By SODO OBH Image Team"))
		self["lab3"] = StaticText(_("Support at") + " www.star7arab.org")
		model = None
		AboutText = ""
		self["lab3"] = StaticText(_("Support at") + " www.star7arab.org")
		...
		AboutText += _("OpenBlackhole Version:\t%s") % getImageVersion() + "\n"
		AboutText += _("OpenBlackhole Build:\t%s") % getImageBuild() + "\n"
...
class ViewGitLog(Screen):
	def __init__(self, session, args=None):
		...
		self["key_yellow"] = Button(_("Show OpenBlackhole Log"))
	...
	def changelogtype(self):
		if self.logtype == 'oe':
			...
			self.setTitle(_("OpenBlackhole E2 Changes"))
			self.logtype = 'e2'
			...
			self["key_yellow"].setText(_("Show OpenBlackhole Log"))
			self.setTitle(_("OE-A Changes"))
			self.logtype = 'oe'
		self.getlog()
